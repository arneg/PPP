...
UTF8.encode = function(str) {
    var buf = new UTIL.StringBuilder();
    var mark = 0;
	...
	if (mark == 0) {
	    ...
	    buf.add(str.substring(mark, str.length));
	}
    }
